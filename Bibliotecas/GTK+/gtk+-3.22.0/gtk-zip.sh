...
ZIP=/tmp/gtk+-3.22.0.zip
DEVZIP=/tmp/gtk+-dev-3.22.0.zip
...
mkdir -p share/doc/gtk+-3.22.0
cp -p /home/leonardo/Bibliotecas_usadas/gtk+-3.22.0/COPYING share/doc/gtk+-3.22.0

mkdir -p share/doc/gtk+-dev-3.22.0
cp -p /home/leonardo/Bibliotecas_usadas/gtk+-3.22.0/COPYING share/doc/gtk+-dev-3.22.0
...
zip -r -D $ZIP share/doc/gtk+-3.22.0
...
zip -r $DEVZIP share/doc/gtk+-dev-3.22.0
